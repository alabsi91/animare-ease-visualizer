...
class MenuTrigger extends HTMLElement implements WCP.IWebComponent {
  static readonly htmlFragment = (() => {
    ...
    template.innerHTML = import_as_string("./menuTrigger-template.inline.html", { minify: true });
    return template.content;
  })();

  static readonly stylesheet = (() => {
    const sheet = new CSSStyleSheet();
    sheet.replace(import_as_string("./menuTrigger-style.inline.css", { minify: true }));
    return sheet;
  })();
